"""
Adversarial Attack Results — MLP / Credit Card Fraud 2023
Generates:
...
ATTACKS = {
    "CaFA":           "cafa_mlp",
    "HopSkipJump":    "hop_skip_jump_mlp",
    "Boundary Attack":"boundary_attack_mlp",
    "SimBA":          "simba_mlp",
    "Square Attack":  "square_attack_mlp",
}
...
ax1.set_title("MLP — Evasiones acumuladas vs presupuesto L∞\nCreditcard Fraud 2023 (n=2000)", fontsize=13)
...
plt.tight_layout()
fig1.savefig(os.path.join(SAVE, "mlp_cumulative_evasions.png"), dpi=150)
print("\nGuardado: mlp_cumulative_evasions.png")
...
ax2.set_title("MLP — Comparativa de métricas por ataque\nCreditcard Fraud 2023 (n=2000)", fontsize=13)
ax2.legend(fontsize=11)
ax2.grid(True, axis="y", alpha=0.3)
plt.tight_layout()
fig2.savefig(os.path.join(SAVE, "mlp_metrics_comparison.png"), dpi=150)
print("Guardado: mlp_metrics_comparison.png")
...
ax3.set_title("MLP — Credit Card Fraud 2023  |  n = 2000 muestras",
              fontsize=12, fontweight="bold", pad=12)
plt.tight_layout()
fig3.savefig(os.path.join(SAVE, "mlp_results_table.png"), dpi=150, bbox_inches="tight")
print("Guardado: mlp_results_table.png")
