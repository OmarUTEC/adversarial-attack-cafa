"""
Adversarial Attack Results — Regresión Logística / Credit Card Fraud 2023
Generates:
...
ATTACKS = {
    "CaFA":           "cafa_logistic_regression",
    "HopSkipJump":    "hop_skip_jump_logistic_regression",
    "Boundary Attack":"boundary_attack_logistic_regression",
    "SimBA":          "simba_logistic_regression",
    "Square Attack":  "square_attack_logistic_regression",
}
...
ax1.set_title("Regresión Logística — Evasiones acumuladas vs presupuesto L∞\nCreditcard Fraud 2023 (n=2000)", fontsize=13)
...
plt.tight_layout()
fig1.savefig(os.path.join(SAVE, "logistic_regression_cumulative_evasions.png"), dpi=150)
print("\nGuardado: logistic_regression_cumulative_evasions.png")
...
ax2.set_title("Regresión Logística — Comparativa de métricas por ataque\nCreditcard Fraud 2023 (n=2000)", fontsize=13)
ax2.legend(fontsize=11)
ax2.grid(True, axis="y", alpha=0.3)
plt.tight_layout()
fig2.savefig(os.path.join(SAVE, "logistic_regression_metrics_comparison.png"), dpi=150)
print("Guardado: logistic_regression_metrics_comparison.png")
...
print("\n── Tabla de resultados Regresión Logística ───────────────────────────────")
...
ax3.set_title("Regresión Logística — Credit Card Fraud 2023  |  n = 2000 muestras",
              fontsize=12, fontweight="bold", pad=12)
plt.tight_layout()
fig3.savefig(os.path.join(SAVE, "logistic_regression_results_table.png"), dpi=150, bbox_inches="tight")
print("Guardado: logistic_regression_results_table.png")
