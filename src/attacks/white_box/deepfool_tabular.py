...
class DeepFoolAttackTabular(DeepFool):
    """
    DeepFool wrapper that projects adversarial samples back to a feasible tabular domain.
    """

    attack_params = DeepFool.attack_params + [
        "feature_clip_min",
        "feature_clip_max",
        "integer_indices",
        "categorical_groups",
